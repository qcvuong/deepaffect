...
class FullNet2:
	...
	@staticmethod
	def build_valence_branch(olla, finalAct="relu"):

		x = Dense(1000, activation='relu')(olla)
		x = Dropout(0.5)(x)
	...
	@staticmethod
	def build_arousal_branch(olla, finalAct="relu"):
	...
	#receive the inputs from the other script (combined-MULT.py)
		...
		sceneBranch = FullNet2.build_scene_branch(inputs, finalAct=finalAct, chanDim=chanDim)
		objectBranch = FullNet2.build_object_branch(inputs, finalAct=finalAct, chanDim=chanDim)
		...
		valenceBranch = FullNet2.build_valence_branch(olla, finalAct=finalAct)
		arousalBranch = FullNet2.build_arousal_branch(olla, finalAct=finalAct)
